...
public class FileTable { // File Structure Table
	...
	/**
	 * default constructor for FileTable
	 * instantiates a file table and the root directory
	 * 
	 * @param directory
	 */
	...
	/**
	 * Returns the underlying file table.
	 *
	 * @return The file table as a Vector of FileTableEntry objects.
	 */
